...
import bgHero1 from './../../../../../public/images/partner-hero-1-desktop.webp'
import bgHero2 from './../../../../../public/images/partner-hero-2-desktop.webp'
import Link from 'next/link'
import ButtonDesignSystem from '../../Button'

const HeroSectionPartner = () => {
  return (
    <div className='relative w-full lg:h-[650px] h-[550px] overflow-hidden'>
      ...
      <span className="ellipse-partner-desktop hidden lg:block"></span>
      <span className="ellipse-partner-mobile lg:hidden block"></span>
      <div className="flex flex-col items-center w-full gap-spacing-xl lg:px-0 px-spacing-xl z-50 absolute lg:pt-10">
        <h1 className="font-sans pt-spacing-10xl bg-transparent text-primary-base-white font-semibold text-display-md leading-display-md  lg:text-display-xl lg:leading-display-xl tracking-display text-center max-w-[992px] m-0 mx-auto">We Are a Partner <br className='block lg:hidden'/> You <br className='lg:block hidden' /> Can Trust</h1>
...
export default HeroSectionPartner
