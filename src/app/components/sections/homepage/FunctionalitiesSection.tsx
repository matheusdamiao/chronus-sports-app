...
import image1 from './../../../../../public/images/desktop-image-function-section-1.webp'
import image2 from './../../../../../public/images/desktop-image-function-section-2.webp'
  ...
  return (
    <div className='py-[50px] flex flex-col text-primary-base-white'>
        <div className='flex flex-col items-center justify-center px-[28px] gap-[21px] lg:max-w-[580px] mx-auto'>
            <h2 className='text-display-sm leading-display-sm tracking-display lg:text-display-lg font-bold lg:leading-display-lg text-center w-[80%] lg:w-full'>The most <span className='complete'>complete</span> sports platform</h2>
        ...
        <div className='flex flex-wrap sm:justify-center gap-spacing-xl max-w-[950px] lg:mx-auto'>
            ...
            <div className='lg:mx-0 mx-4 relative pl-[30px] lg:pl-[42px] pt-[38px] w-full sm:w-[359px] lg:w-[427px] h-[479px] overflow-hidden rounded-4xl border-[1px] border-solid border-[#1E1B3A] bg-gradient-card'>
                <div className='flex flex-col gap-spacing-2xl'>
                    <ButtonDesignSystem label='Become a Creator' className='w-[230px] bg-gradient-button-blue border-none outline-1 outline outline-offset-0 outline-primary-base-white/[0.05] !text-primary-base-white' leftIcon={<Image src={at} alt='' width={20} height={20}/>}  rightIcon={<Image src={chevronBlue} alt=''  width={20} height={20} />} buttonType={'secondaryGray'} normal={'lg'}/>
