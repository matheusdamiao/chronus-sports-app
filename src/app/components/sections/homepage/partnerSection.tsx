...
import paguemenos from './../../../../../public/images/logos-partners/paguemenos.svg'
...
const PartnerSection = () => {
  return (
    <div className='max-w-7xl w-full m-auto lg:py-[100px] pt-[30px] pb-[100px] lg:px-0 px-4'>
      ...
      <div className='lg:flex hidden flex-wrap items-center justify-center max-w-[890px] mx-auto gap-[50px]'>
      {/* desktop order */}
        ...
        <div className='flex flex-wrap items-center justify-center gap-[52px] lg:gap-[141px]'>
          <Image src={paguemenos} alt='logo' width={84.123} height={23.047} className='grayscale'/>
    ...
    {/* mobile order */}
      <div className='flex lg:hidden flex-wrap items-center justify-center max-w-[890px] mx-auto gap-[50px]'>
        <div className='flex flex-wrap items-center justify-center gap-[52px] lg:gap-[141px]'>
          <Image src={abrafarma} alt='logo' width={73.74} height={45.34} className='grayscale'/>
          <Image src={fpf} alt='logo' width={48.557} height={48.557} className='grayscale mx-auto '/>
          <Image src={cbf} alt='logo' width={35.58} height={48.83} className='grayscale mx-auto'/>
