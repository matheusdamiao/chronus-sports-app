...
const HeroSectionVR = () => {
  ...
  return (
    <section className="relative lg:pt-10 z-20 lg:pb-5 overflow-y-hidden">
            ...
            <motion.h4 initial='hidden'  animate='show'  variants={TitleAnimation} transition={{duration: 1}} className="mx-auto max-w-[530px] lg:text-text-md text-text-lg px-3 lg:px-0 lg:pt-5 font-thin text-primary-gray-200 text-center"> We&apos;re revolutionizing how you experience sports, offering interactivity, statistics, and additional information during games. </motion.h4>
