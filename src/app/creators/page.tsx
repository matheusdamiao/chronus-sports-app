...
import HeroSectionCreators from "../components/sections/creatorsPage/heroSectionCreators";
import CarouselCreators from "../components/sections/creatorsPage/carouselCreators";
import PricingCreatorsSection from "../components/sections/creatorsPage/pricingCreatorsSection"
  ...
  export default function Page() {
    ...
    return (
      <div className="bg-[#010317] h-full relative flex flex-col">
        <MainMenu/>
        <HeroSectionCreators/>
        <section className="max-w-4xl w-full mx-auto lg:pb-12 lg:justify-center lg:flex lg:px-0 px-[26px] lg:flex-nowrap grid grid-cols-2 gap-[30px] lg:gap-[58px] mt-[-80px] z-50">
        ...
        <CarouselCreators/>
        <PricingCreatorsSection/>
      
        <div className="lg:mb-[100px] h-full">
          <CtaSection/>
        </div>
        <FooterSection/>
      </div>
